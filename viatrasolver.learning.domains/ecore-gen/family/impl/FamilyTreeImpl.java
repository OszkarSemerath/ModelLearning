 ...
 * </p>
 * <ul>
 *   <li>{@link family.impl.FamilyTreeImpl#getPeople <em>People</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FamilyTreeImpl extends MinimalEObjectImpl.Container implements FamilyTree {
	...
	protected EClass eStaticClass() {
		return FamilyPackage.Literals.FAMILY_TREE;
	}
	...
	public EList<Person> getPeople() {
		if (people == null) {
			people = new EObjectContainmentEList<Person>(Person.class, this, FamilyPackage.FAMILY_TREE__PEOPLE);
		}
		return people;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FamilyPackage.FAMILY_TREE__PEOPLE:
